...
class Sound():
    '''A Sound class is a wrapper for SciPy's io.wavfile class.'''
    ...
    def __init__(self, filename=None, samples=None):
        ...
        self.player = None
        self.numpy_encoding = numpy.dtype('int32')  # default encoding
...
def create_sound(samp):
    ...
    arr = [[0, 0] for i in range(samp)]
    npa = numpy.array(arr, dtype=numpy.dtype('int32'))
